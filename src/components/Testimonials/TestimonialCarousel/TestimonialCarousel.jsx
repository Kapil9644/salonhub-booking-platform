    ...
    <div className="relative w-full">
      ...
      >
        {testimonials.map((testimonial) => (
          <div
            key={testimonial.id}
            className="w-[calc((100%-0.75rem)/2)] min-w-[calc((100%-0.75rem)/2)] shrink-0 snap-start md:w-[calc((100%-3rem)/4)] md:min-w-[calc((100%-3rem)/4)] lg:w-[calc((100%-5rem)/6)] lg:min-w-[calc((100%-5rem)/6)]"
          >
            <TestimonialCard
